  ...
  return (
    <div className='w-full text-black flex justify-between items-center py-5 border-b-[1px] border-b-gray-300 px-4 '>
        <div className='flex items-center gap-6 md:gap-10'>
          <p className='font-semibold text-lg md:text-xl md:font-bold cursor-pointer'>DEVTask</p>
          <p className='text-sm md:text-[16px] cursor-pointer hover:text-blue-600'>Find jobs</p>
        </div>
